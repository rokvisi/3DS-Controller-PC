...
const std::map<std::string, uint32_t> text_to_console_map = {
    ...
    {"KEY_UP",    BIT(6) | BIT(30)}, ///< D-Pad Up or Circle Pad Up
    {"KEY_DOWN",  BIT(7) | BIT(31)}, ///< D-Pad Down or Circle Pad Down
    {"KEY_LEFT",  BIT(5) | BIT(29)}, ///< D-Pad Left or Circle Pad Left
    {"KEY_RIGHT", BIT(4) | BIT(28)}  ///< D-Pad Right or Circle Pad Right
};


// MACOS virtual key codes
// Not really used anywhere but for convenience
enum {
  kVK_ANSI_A                    = 0x00,
  kVK_ANSI_S                    = 0x01,
  kVK_ANSI_D                    = 0x02,
